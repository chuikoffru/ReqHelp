...
export const ERROR_MESSAGES = {
  ...
  page_unavailable:
    'На этой странице Chrome не отдаёт текст (PDF, файл с диска или закрытый фрейм). Вставьте ТЗ вручную или выделите фрагмент и выберите «Проанализировать ТЗ» в меню.',
}
